...
export const t = {
  ...
  benchDesc: i("Strengths and use cases for all 13 flavors. Verified across 9 real scenarios × 18 controlled tests.", "13 种风味的强项和适用场景。基于 9 类真实 bug 场景 × 18 组对照测试（with/without skill）验证。", "13種類のフレーバーの強みと適用シーン。9つの実シナリオ×18組の対照実験で検証。", "Forces et cas d'usage des 13 saveurs. Vérifié sur 9 scénarios réels × 18 tests contrôlés.", "Stärken und Anwendungsfälle aller 13 Varianten. Verifiziert über 9 reale Szenarien × 18 kontrollierte Tests.", "نقاط القوة وحالات الاستخدام لجميع الأنماط 13. تم التحقق عبر 9 سيناريوهات × 18 اختبار مضبوط."),
